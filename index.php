		...
		<div class="row">
			<div class="col-md-6">
			    ...
			    <p>¡Compra, Vende, Ofrece lo que tengas y Gana Dinero!</p>
			  	<p><a class="btn btn-warning btn-lg" href="registrate.php" role="button">Registrate en Nuestra Plataforma</a></p>
			</div>
